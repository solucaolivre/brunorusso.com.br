...
A parte mais desafiadora foi entender como avaliar a performance de um modelo. Quais métricas usar? Como evitar o overfitting e o underfitting? Graças aos exercícios e dedicação aos estudos, consegui desenvolver minhas habilidades de avaliação de modelos. E quando finalmente me senti pronto, agendei a prova. Confesso que fiquei um pouco nervoso, mas a preparação intensa valeu a pena. Ao receber o resultado, senti uma enorme satisfação e um senso de realização.
